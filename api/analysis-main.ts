...
export default async function handler(req: Request) {
    ...
    [핵심 지침 - DETAILED & DEEP]
    1. **풍성하고 디테일한 분석**: 사용자가 자신의 성향과 운명을 깊이 이해할 수 있도록, 분량을 충분히 길고 구체적으로 작성하세요. 단순한 요약이 아닌 깊이 있는 통찰을 제공해야 합니다.
    ...
    - **deepIntegration**: 제목은 "[키워드] 시너지" 형식. 각 포인트는 개조식(-)으로 구체적이고 깊이 있는 해설을 제공하세요.
