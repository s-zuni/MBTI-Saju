...

{
  ...
  "wealthAndCareer": {
    ...
    "details": [
      { "subtitle": "최적의 직업적 환경과 포지셔닝", "content": "강점을 증폭시킬 직업적 환경 상세 서술 (15문장 이상)." },
      { "subtitle": "재물 축적 방식 및 자산 관리 전략", "content": "타고난 財星(재성)의 흐름 바탕 재물 축적 방식 (15문장 이상)." },
  ...
  "relationship": {
    ...
    "details": [
      { "subtitle": "대인관계 역학 및 귀인 활용법", "content": "사회적 관계망에서의 특징과 나에게 도움을 줄 귀인(貴人)을 알아보는 방법. 귀인의 사주 상 오행과 지지 삼합/방합 구조를 명리적으로 밝혀 설명 (15문장 이상)." },
      { "subtitle": "감정의 패턴과 최적의 파트너십", "content": "애정 관계에서의 패턴, 내가 만나야 할 최적의 연인의 일주(日柱), 천간합/지합 등 구체적 명리 조합과 오행 구조 제시 (15문장 이상)." },
      { "subtitle": "운명적 귀인과 악연의 특징", "content": "반드시 곁에 두어야 할 사람과 반드시 피해야 할 악연(惡緣)의 사주 특징. 악연의 일주 및 나와의 충(沖), 원진살(怨嗔煞), 형살(刑煞) 등 부조화 조합을 명리적으로 엄밀하게 분석 (15문장 이상)." },
  ...
  "specialRequestAnalysis": {
    ...
    "details": [
      { 
        ...
        "content": "내담자의 특별 요청사항을 사주원국의 일간 강약, 용신(用神), 기신(忌神), 조후(調候) 관점에서 정밀하게 분석하라. 왜 이 고민이 생겼는지 사주 구조적 원인을 밝히고, 대운과 세운의 흐름에서 어떤 시점에 이 문제가 촉발되었는지 구체적으로 서술하라 (25문장 이상). 요청이 없으면 사주 상 가장 취약한 결핍 오행과 약한 십성을 진단하라." 
      },
      { 
        "subtitle": "현재 운의 흐름과 문제의 시기적 맥락", 
        "content": "현재 대운(大運)과 세운(歲運)의 천간/지지가 내담자 원국과 어떤 합(合)/충(沖)/형(刑)/파(破) 관계를 형성하고 있는지 밝히고, 이것이 요청사항과 어떤 인과관계가 있는지 냉철하게 풀어내라. 예: '2026년 병오(丙午)년에는 화(火) 기운이 과다하여 직업운에 흉조가 있으나, 2027년 정미(丁未)년에는 토(土)가 통관하여 안정 흐름이 형성된다' 식으로 구체적인 연도와 간지를 들어 설명하라 (25문장 이상)." 
      },
      { 
        "subtitle": "직업과 재물 관점의 맞춤 심층 조언", 
        "content": "요청사항이 직업/재물과 관련된 경우, 내담자의 재성(財星), 관성(官星), 식상(食傷)의 배치를 근거로 어떤 업종/환경이 적합한지 극도로 구체적으로 조언하라. '전문직이 아니더라도 내담자의 식신(食神) 성향에 따라 창작/교육/요식업 등의 업종에서 안정적인 흐름을 만들 수 있다' 식으로 현실적 직업 대안을 3가지 이상 제시하라 (25문장 이상). 요청이 직업 관련이 아니면 재물운의 흐름과 주의사항을 서술하라." 
      },
      { 
        "subtitle": "대인관계와 감정 관점의 맞춤 심층 조언", 
        "content": "요청사항이 인간관계/연애/결혼과 관련된 경우, 내담자의 일지(日支) 배우자궁과 월지의 관계, 도화살(桃花煞), 홍염살(紅艶煞) 등을 근거로 어떤 사람을 만나야/피해야 하는지, 언제 좋은 인연이 오는지 구체적 시기와 함께 조언하라 (25문장 이상). 요청이 관계 관련이 아니면 전반적 대인관계 개선 전략을 서술하라." 
      },
      { 
        "subtitle": "연도별 변화 타임라인과 전환점", 
        "content": "요청사항이 해결되는 시기를 연도별로 타임라인 형태로 제시하라. 2026년부터 2029년까지 각 해의 세운이 요청사항에 미치는 영향을 분석하고, 어떤 해에 전환점이 오는지, 어떤 해에 특히 조심해야 하는지 달(月) 단위까지 구체적으로 서술하라 (25문장 이상)." 
      },
      { 
        "subtitle": "마스터의 맞춤 개운 처방과 실천 행동 지침", 
        "content": "요청사항을 근본적으로 해결하기 위한 명리적 개운 처방을 5가지 이상 제시하라. 보강해야 할 오행의 색상/방위/음식/숫자, 피해야 할 시기와 행동, 당장 실천해야 할 3가지 행동 과제를 제시하라. 추상적 조언이 아닌 '매일 아침 동쪽 방향으로 산책하라', '올해 하반기에는 금전 관련 계약을 피하라' 등 극도로 구체적인 처방을 내려라 (25문장 이상)." 
      }
    ]
  },
  "actionPlan": {
...
9. 전체 텍스트 분량은 공백 포함 최소 15,000자 이상이 되어야 합니다. (매우 중요)`;
