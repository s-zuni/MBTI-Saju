...
[절대 준수 규칙 — 위반 시 무효]
1. **영어 단어 사용 완전 금지**: 본문, 제목, 불렛포인트, 키워드 어디에도 영어를 사용하지 마세요. 특히 오행(목, 화, 토, 금, 수)과 계절(봄, 여름, 가을, 겨울)을 영어로 쓰면 절대 안 됩니다.
   - 금지 예시: water, fire, wood, metal, earth, spring, summer, autumn, winter (모두 한글로만 작성)
