...

{
  ...
  "specialRequestAnalysis": {
    ...
    "details": [
      { 
        "subtitle": "요청 사항 분석 및 명리적 진단", 
        "content": "내담자의 특별 요청사항(있을 경우)을 사주원국의 조후, 오행 분포, 일간의 강약 등과 대조하여 어떤 원인과 흐름 때문에 이러한 고민이나 문제가 발생했는지 대가의 시각에서 냉철하고 날카롭게 진단하십시오 (15문장 이상). 만약 특별 요청사항이 없거나 '없음'인 경우, 내담자가 자신의 사주팔자 상 가장 취약한 지점(결핍된 오행이나 약한 십성)을 어떻게 보완하고 대운의 변곡점을 지혜롭게 극복할 것인지에 대한 3단계 심층 진단과 명리 처방 중 1단계 진단을 서술하십시오." 
      },
      { 
        "subtitle": "핵심 쟁점에 대한 냉철 조언", 
        "content": "특별 요청사항의 구체적 의문이나 고민(예: 직장 퇴직 및 이동수, 금전 손실, 특정인과의 부조화 등)에 대해 명리학적 이론과 대운/세운의 흐름을 결합하여 현실적이고 냉정한 해답과 주의해야 할 점을 서술하십시오 (15문장 이상). 특별 요청사항이 없을 경우 3단계 처방 중 2단계 처방(가장 보강이 필요한 핵심 쟁점에 대한 냉철한 조언)을 서술하십시오." 
      },
      { 
        "subtitle": "시기별 극복 방안 및 맞춤 처방", 
        "content": "언제 이 흐름이 해결될 수 있는지 시기별 타임라인과, 내담자가 방책으로 취해야 할 명리적 개운 행동 및 처방을 구체적으로 제시하십시오 (15문장 이상). 특별 요청사항이 없을 경우 3단계 처방 중 3단계 처방(행동지침 및 개운처방)을 서술하십시오." 
      }
    ]
  },
  "actionPlan": {
