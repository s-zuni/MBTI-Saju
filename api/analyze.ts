...
5. 매력도 및 가시성: 도화살, 홍염살, 역마살 등 흥미로운 신살 데이터를 적극 반영하고, 마크다운 **볼드체**를 활용하여 주요 인사이트를 강조하세요. 마크다운 기호 자체는 금지하나, 강조를 위한 볼드체(**텍스트**)는 허용됩니다. 적절한 이모지(✨, 🔮, 💖)를 섞어 몰입감을 높이세요.

응답은 반드시 아래의 JSON 구조와 키 이름을 정확히 일치시켜야 합니다 (JSON 외 추가 텍스트 불가):

{
    "keywords": "융합 특성을 꿰뚫는 트렌디한 키워드 4~5개 (예: #치명적_도화살_ENFp, #영혼의_단짝을_부르는_물기운)",
    "reportTitle": "이 사람의 융합된 영혼과 운명을 상징하는 화려하고 감각적인 제목",
    "nature": {
        "title": "타고난 본성: 사주와 MBTI가 만난 자아의 원형",
        "dayPillarSummary": "일주와 MBTI의 결합 분석. 특히 도화살, 홍염살 등 매력 신살을 활용해 자존감을 높여주는 서사 중심의 분석 (400자 이상)",
        "dayMasterAnalysis": "일간의 오행 에너지가 MBTI 인지 기능과 결합하여 나타나는 본질적 기질 (400자 이상)",
        "dayBranchAnalysis": "내면 사생활과 무의식적 욕구가 MBTI와 어떻게 상충하거나 조화되는지 (300자 이상)",
        "monthBranchAnalysis": "사회적 성공과 직업적 환경에서 발휘되는 융합 에너지의 형태 (300자 이상)"
    },
    "fiveElements": {
        "title": "오행 에너지 & 심리 밸런스 분석",
        "elements": [
            {"element": "목(木)", "count": 0, "function": "심리적 에너지", "interpretation": "해당 오행이 MBTI 성향에 미치는 구체적 영향 해석 (150자 내외)"},
            {"element": "화(火)", "count": 0, "function": "심리적 에너지", "interpretation": "해당 오행이 MBTI 성향에 미치는 구체적 영향 해석 (150자 내외)"},
            {"element": "토(土)", "count": 0, "function": "심리적 에너지", "interpretation": "해당 오행이 MBTI 성향에 미치는 구체적 영향 해석 (150자 내외)"},
            {"element": "금(金)", "count": 0, "function": "심리적 에너지", "interpretation": "해당 오행이 MBTI 성향에 미치는 구체적 영향 해석 (150자 내외)"},
            {"element": "수(水)", "count": 0, "function": "심리적 에너지", "interpretation": "해당 오행이 MBTI 성향에 미치는 구체적 영향 해석 (150자 내외)"}
        ],
        "summary": "오행 분포가 이 사람의 인생 전반과 성격의 균형에 미치는 심층적이고 압도적인 종합 평가 (400자 이상)"
    },
    "romanceDepth": {
