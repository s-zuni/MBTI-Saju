    ...
    "details": [
      {
        ...
        "subtopics": [
          { "subtitle": "연간 총평 및 거시적 흐름", "content": "해당 연도의 전체 운의 흐름과 냉철한 분석 (15문장 이상)." },
          { "subtitle": "재물 및 직업적 성취", "content": "승부처, 투자운, 직업적 이동수 등을 상/하반기 등 분기별로 나누어 상세 서술 (15문장 이상)." },
          { "subtitle": "대인관계 및 애정 흐름", "content": "해당 연도의 인연법, 피해야 할 사람 등 인간관계의 변화 상세 서술 (15문장 이상)." },
          { "subtitle": "건강 관리 및 개운 전략", "content": "신체/정신적 건강 관리법과 흉운을 피하는 디테일한 개운법 (15문장 이상)." }
        ]
      },
      {
        "year": 2027,
        ...
        "subtopics": [
          { "subtitle": "연간 총평 및 거시적 흐름", "content": "해당 연도의 전체 운의 흐름과 사주 구조와의 연관성을 냉철하게 분석하라. 예: '~년도는 ~운이 들어오는 시기로서 내담자의 ~사주는 ~~이 필요함'과 같이 구체적으로 서술하라 (20문장 이상)." },
          { "subtitle": "재물 및 직업적 성취", "content": "승부처, 투자운, 직업적 이동수를 상/하반기 분기별로 나누어 상세 서술하라. 구체적인 직업/분야 명칭과 재테크 비중(포트폴리오)을 예시로 들어라 (20문장 이상)." },
          { "subtitle": "대인관계 및 애정 흐름", "content": "해당 연도의 인연법, 피해야 할 일주와 사주 구조, 귀인을 만나는 시기와 장소 등을 상세 서술하라 (20문장 이상)." },
          { "subtitle": "건강 관리 및 개운 전략", "content": "신체/정신적 건강 관리법과 디테일한 개운법. 특히 구체적인 실천 방안(예: '특히 ~~행동이 필요하고 ~운동이 요구됨. 특히 ~~운동을 하면 더욱 좋음')을 명시하라 (20문장 이상)." }
        ]
      },
      {
        "year": 2028,
      ...
      },
      {
        ...
        "subtopics": [
          { "subtitle": "연간 총평 및 거시적 흐름", "content": "해당 연도의 전체 운의 흐름과 사주 구조와의 연관성을 냉철하게 분석하라. 예: '~년도는 ~운이 들어오는 시기로서 내담자의 ~사주는 ~~이 필요함'과 같이 구체적으로 서술하라 (20문장 이상)." },
          { "subtitle": "재물 및 직업적 성취", "content": "승부처, 투자운, 직업적 이동수를 상/하반기 분기별로 나누어 상세 서술하라. 구체적인 직업/분야 명칭과 재테크 비중(포트폴리오)을 예시로 들어라 (20문장 이상)." },
          { "subtitle": "대인관계 및 애정 흐름", "content": "해당 연도의 인연법, 피해야 할 사람, 귀인을 만나는 시기와 장소 등을 상세 서술하라 (20문장 이상)." },
          { "subtitle": "건강 관리 및 개운 전략", "content": "신체/정신적 건강 관리법과 디테일한 개운법. 특히 구체적인 실천 방안(예: '특히 ~~행동이 필요하고 ~운동이 요구됨. 특히 ~~운동을 하면 더욱 좋음')을 명시하라 (20문장 이상)." }
        ]
      }
    ]
