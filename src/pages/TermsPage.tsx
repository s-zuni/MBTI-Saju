                ...
                <div className="prose prose-slate max-w-none text-slate-600 space-y-6 text-sm">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5">
                            ...
                            <li><strong>코인(크레딧)</strong>: 서비스 내에서 유료 및 특정 콘텐츠를 이용하기 위해 사용되는 가상의 결제수단을 말합니다. (이하 "코인")</li>
                            <li><strong>유효기간</strong>: 충전된 코인의 유효기간 및 환불 가능 기간은 결제일로부터 1년입니다.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-slate-800">제4조 (코인의 구매, 이용 및 환불 정책)</h2>
                        <p>① <strong>서비스 이용 흐름</strong>: 회원은 [회원가입 → 코인 충전 결제 → 각 서비스(분석, 타로 등) 이용]의 단계를 통해 서비스를 이용할 수 있습니다.</p>
                        <p>② <strong>코인의 결제</strong>: 회원은 토스페이먼츠(Toss Payments) 등 회사가 제공하는 결제 대행사를 통해 코인을 충전할 수 있습니다. 1회 충전 가능 금액의 최고 한도는 10만 원 이하로 제한됩니다.</p>
                        <p>③ <strong>환불 정책</strong>:</p>
                        <ul className="list-disc pl-5">
                            <li><strong>환불 가능 조건</strong>: 결제일로부터 7일 이내에 충전한 코인을 전혀 사용하지 않은 경우에 한하여 전액 환불이 가능합니다. 단, 환불 가능 기간은 최대 결제일로부터 1년을 초과할 수 없습니다.</li>
                            <li><strong>환불 수단</strong>: 환불 시 “결제에 사용된 동일 결제수단”으로 환불되는 것을 원칙으로 합니다.</li>
                            <li><strong>부분 환불</strong>: 코인을 일부 사용한 경우, 사용한 코인을 당시 판매가 기준으로 차감한 후 잔액을 환불합니다. 단, 디지털 재화 특성상 사용 직후 가치가 소멸되는 일부 서비스의 경우 환불이 제한될 수 있습니다.</li>
                        </ul>
                        <p>④ <strong>양도 및 유효기간</strong>:</p>
                        <ul className="list-disc pl-5">
                            <li>충전한 코인은 회원 본인만 사용 가능하며, 타인의 계정으로 양도하거나 타인에게 판매할 수 없습니다.</li>
                            <li>코인의 유효기간은 결제일로부터 1년이며, 기간 만료 시 자동으로 소멸됩니다.</li>
                        </ul>
                    </section>
