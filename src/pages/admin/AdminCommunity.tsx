            ...
            <div className="flex justify-between items-end border-b border-slate-100 pb-6">
                <div className="flex gap-8">
                    <button 
                        ...
                        className={`text-2xl font-black tracking-tight pb-2 transition-all ${adminTab === 'posts' ? 'text-slate-800 border-b-4 border-slate-950' : 'text-slate-300 hover:text-slate-400'}`}
                    >
                        커뮤니티 관리
                    </button>
                    <button 
                ...
                <div className="flex items-center gap-4">
                    {adminTab === 'posts' && (
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 bg-slate-950 text-white rounded-2xl font-bold hover:bg-black transition-all shadow-lg shadow-slate-200"
                        >
                            <Plus size={18} />
                            게시물 작성
                        </button>
                    ...
                    <div className="text-right border-l border-slate-100 pl-4">
                        ...
                        <p className={`text-xl font-black ${adminTab === 'posts' ? 'text-slate-950' : 'text-rose-600'}`}>
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border-none rounded-2xl pl-11 pr-4 py-3 text-sm focus:ring-2 focus:ring-slate-950 transition-all outline-none font-medium"
                                />
                            </div>
                                ...
                                {loading ? (
                                    <tr>
                                        <td colSpan={4} className="px-6 py-20 text-center">
                                            <Loader2 className="animate-spin text-slate-950 mx-auto mb-2" size={32} />
                                    ...
                                    posts.map((post) => (
                                        <tr key={post.id} className="hover:bg-slate-50/50 transition-colors group">
                                            <td className="px-6 py-4">
                                                <span className="block text-xs font-black text-slate-950 mb-1">{post.tag || '일반'}</span>
                                            ...
                                            <td className="px-6 py-4 max-w-md">
                                                <p className="text-sm font-bold text-slate-800 group-hover:text-slate-950 transition-colors line-clamp-1 mb-1">
                                ...
                                {loading ? (
                                    ...
                                    reports.map((report) => (
                                        <tr key={report.id} className={`hover:bg-slate-50/50 transition-colors group ${report.status !== 'pending' ? 'opacity-50' : ''}`}>
                                            <td className="px-6 py-4">
                                                <span className={`block text-xs font-black mb-1 ${report.post_id ? 'text-slate-950' : 'text-amber-600'}`}>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                {report.status === 'pending' ? (
                                                    ...
                                                    <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${report.status === 'resolved' ? 'bg-slate-100 text-slate-950' : 'bg-slate-100 text-slate-400'}`}>
                    ...
                    <div className="bg-white w-full max-w-xl rounded-[32px] shadow-2xl overflow-hidden animate-slide-up">
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-2 text-left">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-slate-50 border-none rounded-[20px] text-sm font-bold focus:ring-2 focus:ring-slate-950 transition-all outline-none"
                                />
                            </div>
                            ...
                            <div className="space-y-2 text-left">
                                ...
                                <textarea
                                    ...
                                    rows={8}
                                    className="w-full px-5 py-4 bg-slate-50 border-none rounded-[20px] text-sm font-medium focus:ring-2 focus:ring-slate-950 transition-all outline-none resize-none"
                                />
                            </div>
                        </div>
                        ...
                        <div className="p-8 bg-slate-50/50 border-t border-slate-50 flex gap-3">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="flex-[2] py-4 bg-slate-950 text-white font-bold rounded-2xl hover:bg-black transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2"
                            >
