                ...
                <div className="prose prose-slate max-w-none text-slate-600 space-y-6 text-sm">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5">
                            ...
                            <li><strong>서비스 제공 및 1:1 심층 분석</strong>: 1,000만 건 데이터 분석 기반 1대1 심층 운명 상담(/chat) 및 사주 분석 결과 제공.
                                <br />- 수집항목: 생년월일, 성별, 태어난 시간(선택), MBTI 유형, 상담 질문 내용</li>
                            <li><strong>전문가 수기 점검 프리미엄 (4년 심층 리포트) 서비스</strong>: 전문가 수기 검증 분석 및 리포트 전달.
                                <br />- 수집항목: 이메일 (결과물 발송), 카카오톡 ID (선택 발송 및 상담 보조), 생년월일시, 성별, MBTI 등 입력 정보</li>
                            <li><strong>요금 결제 및 환불</strong>: 유료 서비스(크레딧 충전 및 심층 리포트/상품 구매) 결제, 환불 및 영수증 발급.
                                <br />- 수집항목: 결제 기록, 결제 수단 정보(토스페이먼츠 제공 항목)</li>
                            <li><strong>실물 상품 배송</strong>: 운세 상점 내 실물 상품의 주문 처리 및 배송.
                                <br />- 수집항목: 주문자 정보, 수령인 이름, 배송지 주소, 수령인 연락처(휴대폰 번호)</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>
                                ...
                                <br />- 제공 목적: 크레딧 및 실물 상품 구매를 위한 신용카드, 간편결제 등 요금 결제 대행
                            </li>
                            <li>
                                <strong>실물 상품 배송 업무</strong>
                                <br />- 수탁자: 우체국택배, CJ대한통운 등 배송 대행 택배사
                                <br />- 제공 목적: 구매 상품의 배송 및 배송 위치 추적 서비스 제공
                            </li>
                        </ul>
                    </section>
