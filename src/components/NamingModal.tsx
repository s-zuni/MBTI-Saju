...
const NamingModalContent: React.FC<NamingContentProps> = ({ onUseCredit, credits, session, onReset }) => {
                    ...
                    {isLoading && !result ? (
                        ...
                        <div className="space-y-12 animate-fade-up">
                            ...
                            <div className="flex flex-col items-center pt-10 border-t border-slate-100 gap-4">
                                ...
                                <button onClick={onReset} className="text-slate-400 text-xs font-bold hover:text-slate-950 transition-colors underline underline-offset-4">새로운 정보로 다시 분석하기</button>
                            </div>
                        </div>
                    ) : null}
                </div>
...
const NamingModal: React.FC<NamingModalProps> = (props) => {
