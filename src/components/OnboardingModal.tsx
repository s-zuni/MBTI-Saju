    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            `}>
                ...
                <div className="absolute top-0 inset-x-0 h-32 bg-slate-950"></div>
                ...
                <div className="relative pt-10 px-8 pb-8 flex flex-col items-center text-center">
                    ...
                    <div className="w-20 h-20 bg-white rounded-full shadow-lg flex items-center justify-center mb-6 relative z-10">
                        <Sparkles className="w-10 h-10 text-slate-950 fill-slate-100" />
                    </div>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 mb-6 shadow-sm relative overflow-hidden">
                        <div className="absolute -right-4 -top-4 w-12 h-12 bg-slate-200/30 rounded-full blur-xl"></div>
                        <p className="text-slate-700 font-bold text-sm">
                            사주, MBTI 분석부터 신비타로까지<br />
                            당신만을 위한 맞춤 운세 브리핑이 제공됩니다.
                        </p>
                        <p className="text-slate-500 text-xs mt-2 font-semibold">
                            지금 가입 축하 <span className="text-slate-950 font-bold">10 크레딧</span>이 지급되었습니다!<br />
                    ...
                    <div className="w-full space-y-3">
                        <button
                            onClick={onClose}
                            className="w-full py-3.5 bg-slate-950 text-white rounded-xl font-bold font-lg shadow-lg shadow-slate-200 hover:bg-slate-800 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                        >
