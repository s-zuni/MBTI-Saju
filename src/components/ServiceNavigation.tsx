...
export type ServiceType = 'fortune' | 'mbti' | 'trip' | 'naming' | 'cherry' | 'compatibility';
...
const services = [
    ...
    { id: 'cherry', label: '벚꽃', icon: Ticket, color: 'text-pink-400', userCount: '1,200+', isPopular: true },
