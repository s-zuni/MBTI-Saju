...
const ZHI_MAP: { [key: string]: { element: string; polarity: string; korean: string } } = {
    '子': { element: 'water', polarity: '+', korean: '자수' },
    '丑': { element: 'earth', polarity: '-', korean: '축토' },
    '寅': { element: 'wood', polarity: '+', korean: '인목' },
    '卯': { element: 'wood', polarity: '-', korean: '묘목' },
    '辰': { element: 'earth', polarity: '+', korean: '진토' },
    '巳': { element: 'fire', polarity: '-', korean: '사화' },
    '午': { element: 'fire', polarity: '+', korean: '오화' },
    '未': { element: 'earth', polarity: '-', korean: '미토' },
    '申': { element: 'metal', polarity: '+', korean: '신금' },
    '酉': { element: 'metal', polarity: '-', korean: '유금' },
    '戌': { element: 'earth', polarity: '+', korean: '술토' },
    '亥': { element: 'water', polarity: '-', korean: '해수' },
};
...
// Clean version without extra or-guards
